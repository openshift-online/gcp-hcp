...
| [cross-region-resource-replication](infrastructure/cross-region-resource-replication.md) | Single-leader Pub/Sub replication for API resources with read-only follower mirrors |

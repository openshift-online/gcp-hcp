...
# Applies the console-demo console overlay to the live HostedCluster.
...
# kustomization root (console/kustomize/console-demo). Kustomize blocks
...
# Must point at the *management* cluster hosting the HostedControlPlane namespace.
